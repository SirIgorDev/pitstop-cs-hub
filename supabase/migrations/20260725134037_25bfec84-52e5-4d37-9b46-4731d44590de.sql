...
AS $$
DECLARE
  target_existing_role public.app_role;
  target_existing_active BOOLEAN;
...
BEGIN
  ...
  SELECT profile.role, profile.ativo
  INTO target_existing_role, target_existing_active
  ...
  IF target_existing_role = 'admin'::public.app_role
     AND target_existing_active
