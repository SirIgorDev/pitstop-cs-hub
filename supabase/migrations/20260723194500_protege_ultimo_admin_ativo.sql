-- Permite que um administrador seja inativado ou rebaixado somente quando
-- outro administrador ativo permanecer no sistema.
...
BEGIN
  ...
  -- Serializa alterações de perfil para impedir duas inativações simultâneas
  -- de deixarem o sistema sem administrador ativo.
