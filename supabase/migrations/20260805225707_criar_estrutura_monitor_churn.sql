...
-- Os arquivos originais nao sao alterados: substituicoes inativam os metadados
-- anteriores e preservam as linhas vinculadas para auditoria.

-- Mantem o fallback legado funcional quando o RBAC for desligado para rollback.
