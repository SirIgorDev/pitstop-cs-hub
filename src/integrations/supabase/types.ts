  ...
  public: {
    Tables: {
      access_control_settings: {
        Row: { id: boolean; rbac_enabled: boolean; updated_at: string; updated_by: string | null };
        Insert: {
          id?: boolean;
    ...
    Functions: {
      admin_assign_user_cargo: {
        Args: { target_user_id: string; next_cargo_id: string; next_active: boolean };
        Returns: undefined;
      };
      admin_save_cargo: {
        Args: {
      ...
      admin_set_rbac_enabled: { Args: { next_enabled: boolean }; Returns: undefined };
      current_user_access: { Args: Record<PropertyKey, never>; Returns: Json };
      current_user_has_permission: { Args: { permission_code: string }; Returns: boolean };
